  ...
  return (
    <div className="pt-28 pb-16">
      ...
      <Section className="section-pad max-w-4xl mx-auto">
        <h2 className="text-2xl md:text-3xl font-bold mb-6">{tx.whatIsSeo.heading}</h2>
        <p
      ...
      {/* ── Ne yapıyoruz? ── */}
      <Section className="section-pad max-w-4xl mx-auto">
        <h2 className="text-2xl md:text-3xl font-bold mb-8">{tx.whatWeDo.heading}</h2>
        <div className="grid md:grid-cols-2 gap-6">
          {tx.whatWeDo.items.map((item: { title: string; desc: string }, i: number) => (
            <div
              key={i}
      ...
      <Section className="section-pad max-w-4xl mx-auto">
        ...
        <div className="flex flex-col gap-6">
          {tx.faq.items.map((item: { q: string; a: string; link?: string }, i: number) => (
            <div
              key={i}
              ...
              <p className="text-sm leading-relaxed" style={{ color: "var(--text-muted)" }}>
                ...
                {item.link && (
                  <>
                    ...
                    >
                      {lang === "tr" ? "GEO hizmet sayfamız →" : "Our GEO service page →"}
                    </a>
                  </>
                )}
              </p>
